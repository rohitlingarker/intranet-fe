// ManagerApprovalTable.jsx
import React, { useMemo, useState } from "react";
import jsPDF from "jspdf";
import autoTable from "jspdf-autotable";
import LoadingSpinner from "../../../components/LoadingSpinner";
import { reviewTimesheet } from "../api";
import { TimesheetGroup } from "../TimesheetGroup"; // ✅ reusing your weekly UI
...
const ManagerApprovalTable = ({
  ...
  // Flattened data for exports
  const timesheets = useMemo(
    () =>
      groupedData.flatMap((user) =>
        user.weeklySummary.flatMap((week) =>
          week.timesheets.map((t) => ({
            ...
            weeklyStatus: week.weeklyStatus,
          }))
        )
      ),
    [groupedData]
  ...
  const renderUserWeeks = (user) =>
    user.weeklySummary
      ...
      .map((week) => (
        ...
        >
          {/* ✅ Render TimesheetGroup (Weekly UI) */}
          <TimesheetGroup
            weekGroup={{
            ...
            projectInfo={[]} // you can pass your actual project/task info here
          />

          {/* Manager-level approve/reject actions */}
